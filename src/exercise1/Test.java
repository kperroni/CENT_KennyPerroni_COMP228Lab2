...
public class Test {
	...
	//Questions
	private final String[] question = { "What programming paradigm does java follow?", "What is an Object in OO Programming?",
			"Where is the java source code compiled?", "What is the correct way to create an Object?", "Which of the following placeholders should be used to print off a String?" }; 
	
	private final String[] options = {"a) Functional\nb) Object-Oriented\nc) Logical\nd) Procedural", //Options for Q1
	...
	private final String[] answerSentence = {"b) Object-Oriented", "a) An entity that can be described with attributes, behaviour and state",
			"b) It is compiled in the JVM", "c) Classname variable = new Classname(parameters)", "d) %s"};
	...
	public void inputAnswer() {
		...
		JOptionPane.showMessageDialog(null, "Summary:\n\n"
				...
				+ "Questions answered wrongly: "+this.incorrectAnswers+"\n---------------------------------------------\n"
						+ "Total: "+(((double)this.correctAnswers/(double)this.question.length)*100)+"%/100%","Marks",1);
